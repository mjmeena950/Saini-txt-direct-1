    ...
    try:
        for i in range(arg-1, end):
            ...
            if "edge.api.brightcove.com" in url:
                bcov = 'bcov_auth=eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9.eyJhY2NpZCI6IjY0MTU2MzY2MTEwMDEiLCJleHAiOjE3NDQ4NzgyNzMsImlhdCI6MTc0NDc5MTg3MywiY29uaWQiOiI2MzU1OTA5MTczMTEyIiwibWF4aXAiOjF9.U7eU2SIfoKd0PXw_NO2_tN0d0GqqLgaaNI6q9utYdRaQCmFvKM_2B5NnA_zP4GGmDFMAsJxSBt-XP2QhXKDQXIPZDNsPkeb2Gr86aWMvoek0DxC3u8b9ujg39SBYYMOuILSdvG2BUPCGXMIDC57XycrH0IkzJ0x37P_t7UvOL6SrE2K5r_FWAK8K40IAK-3gdOlT_aav19eK5KibACG67Hp5zvUfP9MBQjkMAmNXFQ7xfckSpg26Tv2EVVOLsFMxUyHG95pfdfwPnZGHKHHroWX3gKaApq6D_Wwkr2tXJJ329TY8RUyPKTcyk4VYaZHMfJgGMmbSe4D1lR8P03eBRw'
        ...
        for i in range(arg-1, len(links)):
            ...
            try:  
                ...
                if ".pdf" in url or "drive" in url or ".jpg" in url or ".jpeg" in url or ".png" in url:
                    try:
                        await m.reply_text(text=f'——— ✨ [{str(count).zfill(3)}]({link0}) ✨ ———\n\n📔𝐓𝐢𝐭𝐥𝐞 » `{name}`\n\n✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ `♛𝕸𝖊𝖊𝖓𝖆 𝖏𝖎♛™`', disable_web_page_preview=True, reply_markup=BUTTONSDOC)
                        count +=1
                    except Exception as e:
                        await m.reply_text(str(e))    
                        time.sleep(3)    
                    ...
                    try:
                        await m.reply_text(text=f'——— ✨ [{str(count).zfill(3)}]({link0}) ✨ ———\n\n📔𝐓𝐢𝐭𝐥𝐞 » `{name}`\n\n✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ `♛𝕸𝖊𝖊𝖓𝖆 𝖏𝖎♛™`', disable_web_page_preview=True, reply_markup=BUTTONSCP)
                        count +=1
                    except Exception as e:
                        await m.reply_text(str(e))    
                        time.sleep(3)    
                    ...
                    try:
                        await m.reply_text(text=f'——— ✨ [{str(count).zfill(3)}]({link0}) ✨ ———\n\n📔𝐓𝐢𝐭𝐥𝐞 » `{name}`\n\n✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ `♛𝕸𝖊𝖊𝖓𝖆 𝖏𝖎♛™`', disable_web_page_preview=True, reply_markup=BUTTONSYT)
                        count +=1
                    except Exception as e:
                        await m.reply_text(str(e))    
                        time.sleep(3)    
                ...
                await m.reply_text(text=f'——— ✨ [{str(count).zfill(3)}]({link0}) ✨ ———\n\n📔𝐓𝐢𝐭𝐥𝐞 » `{name}`\n\n✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ `♛𝕸𝖊𝖊𝖓𝖆 𝖏𝖎♛™`', disable_web_page_preview=True, reply_markup=BUTTONSMAN)
                count += 1
                time.sleep(3)
                continue
